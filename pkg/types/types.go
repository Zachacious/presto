...
type ProcessingOptions struct {
	...
	ContextPatterns []string // Patterns for context files
...
type CommentStyle struct {
	SingleLine string   // e.g., "//" for Go
	MultiStart string   // e.g., "/*" for Go
	MultiEnd   string   // e.g., "*/" for Go
	DocStyle   []string // e.g., ["///", "/**"] for documentation comments
}
